...
def generate_training_data(config, bert_tokenizer="bert-base", do_lower_case=True):
    ...
    train_sentences, train_labels, label_set = load_BioRED('train')
    print('train_sentences: ', train_sentences[0])
    ...
    dev_sentences, dev_labels, _ = load_BioRED('val')
...
def train(train_iter, eval_iter, tag2idx, config,
